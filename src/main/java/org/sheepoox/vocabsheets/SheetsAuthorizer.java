...
public class SheetsAuthorizer {
     ...
     * @throws IOException
     */
    public Sheets getSheetsService(final String applicationName) throws IOException {
    ...
    // Bill Pugh Singleton initialization, thread-safe
    private static class SingletonHelper {
        private static final SheetsAuthorizer INSTANCE = new SheetsAuthorizer();
    }

    public static SheetsAuthorizer getInstance() {
